    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">About <span className="gradient-text">HackFusion</span></h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            HackFusion brings together the brightest minds to solve real-world problems through technology and innovation.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div>
            <h3 className="text-2xl font-bold mb-6">What is HackFusion?</h3>
            <p className="text-gray-700 mb-4">
              HackFusion is a premier 48-hour hackathon that challenges participants to build innovative solutions to real-world problems. Whether you're a seasoned developer or just starting out, HackFusion offers an inclusive environment for learning, collaboration, and growth.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              Join us in San Francisco or virtually from anywhere in the world!
            </p>
          </div>
