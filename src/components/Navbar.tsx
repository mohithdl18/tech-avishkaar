...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-5 left-1/2 transform -translate-x-1/2 z-50 w-11/12 md:w-3/4 rounded-2xl transition-all duration-300 ${isScrolled ? "bg-white/50 backdrop-blur-md shadow-md" : "bg-transparent"
        }`}
    >
